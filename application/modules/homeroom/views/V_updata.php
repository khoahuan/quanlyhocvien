	  ...
	  <!-- Stack the columns on mobile by making one full-width and the other half-width -->
		...
		<div class="row">
			<h1 class="text-center ">
				<a href="<?= base_url('home'); ?>">PHÂN CÔNG CHỦ NHIỆM</a><button type="button" class="btn btn-default btn-xs click-show-more ">Ẩn ▲</button>
			</h1>
			<div class="col-xs-8 col-sm-4 col-md-4 tbl_up">
				<h5>Mã phân công:</h5>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-10 col-md-7">
				<h3><span>DANH SÁCH PHÂN CÔNG:</span></h3>
